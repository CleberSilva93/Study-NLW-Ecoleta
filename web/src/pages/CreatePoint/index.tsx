...
const CreatePoint = () => {
    ...
    const history = useHistory();
        ...
        useEffect(() => {
                // carregar as cidades sempre que selecionar
                if(selectedUf === '0'){
                    return;
                }
        ...
        },[selectedUf])// esse segundo array, serve para dizer quando esse use select deve ser executado
       ...
       async function handleSubmit(event: FormEvent){
           ...
           // CRIAR TEAL DE CADATRO CONCLUÍDO
        }
    return (
